using DumbPaymentMachine.Services;
...
builder.Services.AddScoped<DumbPaymentMachineService>();
...
app.MapGrpcService<DumbPaymentMachineService>().EnableGrpcWeb().RequireCors("AllowAll");
