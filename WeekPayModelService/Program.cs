...
using WeekPayModelServices = WeekPayModelService.Services;
...
//    .LoadFromConfig(builder.Configuration.GetSection("WeekPayModelLoadBalancer"));
...
builder.Services.AddScoped<WeekPayModelServices.WeekPayModelService>();
...
WeekPayModelManager.Instance.Init<MicroservicesProtos.WeekPayModel.WeekPayModelClient>(customLBPP,
    (WeekPayModelServices.WeekPayModelService)builder.Services.BuildServiceProvider().GetRequiredService(typeof(WeekPayModelServices.WeekPayModelService)),
    machineIP,
...
app.MapGrpcService<WeekPayModelServices.WeekPayModelService>().EnableGrpcWeb().RequireCors("AllowAll");
